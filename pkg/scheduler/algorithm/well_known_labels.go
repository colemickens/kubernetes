...
const (
	...
	AnnotationDefaultTolerations = "scheduler.kubernetes.io/defaultTolerations"
	...
	AnnotationTolerationsWhitelist = "scheduler.kubernetes.io/tolerationsWhitelist"
	...
	// The annotation key scheduler.kubernetes.io/node-selector is for assigning
	// node selectors labels to namespaces
	AnnotationNamespaceNodeSelector = "scheduler.alpha.kubernetes.io/node-selector"
	...
	DeprecatedAnnotationNamespaceNodeSelector = "scheduler.kubernetes.io/node-selector"
)
