...
// Remove after deprecation period (deprecated in 1.10)
// The annotation keys for default and whitelist of tolerations
// TODO(@colemickens): per resourer recommendations/past PR: convert these to a newer version (https://github.com/kubernetes/kubernetes/pull/51266)
const (
	deprecatedAnnotationDefaultTolerations    string = "scheduler.alpha.kubernetes.io/defaultTolerations"
	deprecatedAnnotationTolerationsWhitelist  string = "scheduler.alpha.kubernetes.io/tolerationsWhitelist"
)
...
// scheduler.kubernetes.io/defaultTolerations and scheduler.kubernetes.io/tolerationsWhitelist
// annotations keys.
...
func (p *podTolerationsPlugin) getNamespaceDefaultTolerations(nsName string) ([]api.Toleration, error) {
	...
	return extractNSTolerations(ns, algorithm.AnnotationDefaultTolerations)
}
...
func (p *podTolerationsPlugin) getNamespaceTolerationsWhitelist(nsName string) ([]api.Toleration, error) {
	...
	return extractNSTolerations(ns, algorithm.AnnotationTolerationsWhitelist)
}

// extractNSTolerations extracts default or whitelist of tolerations from
// following namespace annotations keys: "scheduler.kubernetes.io/defaultTolerations"
// and "scheduler.kubernetes.io/tolerationsWhitelist". If these keys are
